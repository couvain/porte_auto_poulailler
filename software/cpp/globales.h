...
const int G_DELAI_REPRISE   = 3000;	// 3 secondes
const int G_DELAI_OUVERTURE = 5000;	// 5 secondes TODO à mesurer
const int G_DELAI_FERMETURE = 5000;	// 5 secondes TODO à mesurer
